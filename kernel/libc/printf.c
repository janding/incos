...
const char* lltoa(long long n, char* buffer, int radix, char pad, int width, int uppercase)
{
...
const char* ulltoa(unsigned long long n, char* buffer, int radix, char pad, int width, int uppercase)
{
	const char *digits = uppercase ? "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ" 
								   : "0123456789abcdefghijklmnopqrstuvwxyz";
	char tbuf[130], *p = tbuf, *d;
